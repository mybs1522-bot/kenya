    ...
    <div className={`${bgClass} rounded-2xl px-5 py-6 relative overflow-hidden max-w-sm mx-auto`}>
      ...
      <div className="relative z-10 flex flex-col items-center text-center gap-3">
        ...
        <div className="flex items-baseline gap-2">
          <span className={`text-sm ${variant === 'dark' ? 'text-slate-500' : 'text-slate-400'} line-through font-bold`}>GH₵990</span>
          <span className={`text-3xl font-display font-black ${variant === 'dark' ? 'text-white' : 'text-slate-900'}`}>GH₵150</span>
...
const LandingPage: React.FC = () => {
  ...
  useEffect(() => { window.scrollTo(0, 0); if ((window as any).fbq) (window as any).fbq('track', 'ViewContent', { content_name: 'Avada Design — SketchUp + V-Ray + D5 Render AI', value: 150, currency: 'GHS' }); }, []);
    ...
    <div className="min-h-screen bg-white text-gray-900 font-sans overflow-x-hidden selection:bg-orange-100">
      ...
      <header className="sticky top-0 z-[60] bg-white/80 backdrop-blur-2xl border-b border-slate-100/60 px-5 py-4">
        <div className="max-w-7xl mx-auto flex items-center justify-between">
          ...
          <div className="flex items-center gap-4">
            <button onClick={openPaymentModal} className="text-white px-6 py-2.5 rounded-full text-xs font-black uppercase tracking-widest hover:scale-105 transition-all premium-stroke" style={{ background: 'linear-gradient(135deg,#f97316,#ea580c)', boxShadow: '0 0 20px rgba(249,115,22,0.45)' }}>Get Access — GH₵150</button>
          </div>
        </div>
      </header>
      ...
      <main>
          ...
          <div className="w-full px-4 md:max-w-3xl md:mx-auto relative z-10">
            <div className="flex flex-col items-center text-center pt-7 md:pt-14">
              ...
              <button onClick={openPaymentModal} className="w-full sm:w-auto px-8 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-2xl font-bold text-base md:text-lg shadow-xl shadow-orange-500/20 hover:shadow-orange-500/30 hover:scale-[1.03] transition-all flex items-center justify-center gap-3 group premium-stroke">
                ...
                Get All 3 Courses — GH₵150 <ArrowRight className="group-hover:translate-x-1 transition-transform" size={18} />
              </button>
        ...
        <section className="py-16 bg-white border-b border-slate-200">
          <div className="max-w-5xl mx-auto px-5">
            <div className="reveal text-center mb-10">
              <h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 tracking-tight mb-4">Your GH₵150 Investment <br className="hidden md:block" /><span className="text-orange-600">Pays for Itself 100x Over</span></h2>
            </div>
            ...
            <div className="reveal max-w-3xl mx-auto bg-white border border-slate-200 rounded-2xl overflow-hidden shadow-soft">
              ...
              <div className="bg-orange-50/50 border-t border-orange-200 px-6 py-6 flex flex-col items-center gap-6 justify-center">
                ...
                <button onClick={openPaymentModal} className="w-full sm:w-auto px-10 py-4 bg-gradient-to-r from-orange-500 to-orange-600 text-white rounded-xl font-bold text-lg shadow-xl shadow-orange-500/20 hover:scale-[1.02] transition-all flex items-center justify-center gap-3 group premium-stroke whitespace-nowrap">
                  <Download size={16} /> Get All 3 Courses — GH₵150 <ArrowRight className="group-hover:translate-x-1 transition-transform" size={18} />
                </button>
              </div>
            </div>
          </div>
            ...
            <div className="reveal space-y-6 text-slate-600 text-base md:text-lg leading-relaxed">
              ...
              <div className="my-10 bg-gradient-to-br from-orange-50 to-orange-50 border border-orange-200 rounded-2xl p-6 md:p-8 shadow-soft">
                ...
                <div className="mt-6 pt-6 border-t border-orange-100 flex items-center justify-between">
                  <span className="text-slate-600 text-sm italic font-bold">The complete design-to-render ecosystem for just GH₵150.</span>
              ...
              <p className="text-slate-900 font-semibold text-lg md:text-xl border-l-4 border-orange-500 pl-4 bg-orange-50 p-4 rounded-r-xl">Stop collecting bookmarks. Start building a portfolio. 50,000+ students already did — and they started with the same GH₵150 decision you're about to make.</p>
            </div>
          </div>
        </section>
        ...
        <section className="py-16 md:py-24 bg-white grid-bg">
          <div className="max-w-5xl mx-auto px-5">
            <div className="reveal text-center mb-12"><h2 className="text-3xl md:text-5xl font-display font-bold text-slate-900 tracking-tight mb-4">The Slow, Expensive Path <br className="hidden md:block" />vs. <span className="text-orange-600">Our GH₵150 Shortcut</span></h2></div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="reveal bg-gradient-to-br from-orange-50 to-slate-50 border border-orange-200 rounded-2xl p-8 shadow-soft">
                <div className="flex items-center gap-3 mb-6"><div className="w-10 h-10 rounded-xl bg-orange-100 flex items-center justify-center"><CheckCircle size={20} className="text-orange-600" /></div><h3 className="text-xl font-bold text-slate-900">The GH₵150 Bundle</h3></div>
                <ul className="space-y-4">
        ...
        <section className="py-16 md:py-24 bg-slate-50 border-t border-slate-200 grid-bg">
          ...
          <div className="max-w-3xl mx-auto px-4 md:px-5">
            <div className="text-center mb-6 md:mb-8">
              ...
              <p className="text-slate-500 text-xs md:text-sm">50,000+ students chose this path. SketchUp + V-Ray + D5 Render AI for GH₵150. Lifetime access. Zero risk.</p>
            </div>
        ...
        <div className="w-full bg-white/98 backdrop-blur-2xl border-t border-slate-100 shadow-[0_-1px_40px_rgba(15,23,42,0.12)] px-4 py-2.5 flex items-center gap-3">
          ...
          <div className="flex flex-col items-start gap-0.5 shrink-0">
            <div className="flex items-baseline gap-1.5">
              <span className="text-base font-black text-slate-900">GH₵150</span>
